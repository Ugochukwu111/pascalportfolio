...
export function GenerateNavBarHTML(idName){
  const html = `<ul class="d-flex f-wrap justify-s-center">
          ...
          <li title="experience">
            <a href="index.html#experience" aria-label="Experience">
