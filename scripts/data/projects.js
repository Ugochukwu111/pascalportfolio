export const myProjects = [
  {
    ...
    name:'wePay',
    description: 'is a payment solution prototype I’m building with a team of four. As the Frontend Developer, I focus on the UI and user interactions while collaborating with a PM, Backend, and QA to deliver a smooth payment experience.',

    longDescription:"WePay is a payment solution prototype I’m building in a team of four: a Project Manager, Backend Developer, QA Engineer, and myself as the Frontend Developer. I focus on crafting the UI and user interactions, while the backend handles secure payment flows and QA ensures stability.This project is sharpening my frontend skills and giving me hands-on experience in team collaboration, agile workflow, and cross-functional development as we work toward a usable prototype.",
